...
class MLOpsProjectUser(HttpUser):
    ...
    def analyze_doc_groq_instant(self):
        ...
        payload = {"content": "def hello(): print('world')", "language": "python", "mode": "doc", "provider": "instant"}
    ...
    def analyze_doc_gemini(self):
        ...
        payload = {"content": "class Database: pass", "language": "python", "mode": "doc", "provider": "gemini"}
